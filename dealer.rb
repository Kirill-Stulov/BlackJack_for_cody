...
class Dealer < Player
  ...
  def self.card_calc(player, card) # нужно оптимизирвоать через send
  ...
  def self.one_or_ten(player, card)  # это можно переделать через send
